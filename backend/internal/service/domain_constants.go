...
const (
	...
	SettingKeyURLAllowlistEnabled              = "url_allowlist_enabled"               // 是否启用上游 URL 白名单
	SettingKeyURLAllowlistUpstreamHosts        = "url_allowlist_upstream_hosts"        // 上游 URL 白名单 host 列表（JSON 数组）
