...
func TestOpenAIGatewayService_OAuthPassthrough_DropsUnsupportedAutoServiceTier(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	originalBody := []byte(`{"model":"gpt-5.4","stream":false,"service_tier":"auto","input":[{"type":"text","text":"hi"}]}`)
