...
type Config struct {
	...
	CodexRegistration       CodexRegistrationConfig       `mapstructure:"codex_registration"`
	AccountRegistration     AccountRegistrationConfig     `mapstructure:"account_registration"`
...
// CodexRegistrationConfig controls host-file scan and probe behavior.
type CodexRegistrationConfig struct {
...
func setDefaults() {
	...
	// Codex Registration
	viper.SetDefault("codex_registration.scan_workers", 4)
	viper.SetDefault("codex_registration.probe_timeout_seconds", 8)
	viper.SetDefault("account_registration.worker_api_key", "")
...
func (c *Config) Validate() error {
	...
	if c.CodexRegistration.ScanWorkers <= 0 {
		return fmt.Errorf("codex_registration.scan_workers must be positive")
	}
	if c.CodexRegistration.ProbeTimeoutSeconds <= 0 {
		return fmt.Errorf("codex_registration.probe_timeout_seconds must be positive")
	}
