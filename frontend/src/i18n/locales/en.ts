export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      importModelsSuccess: 'Imported {count} models',
      importModelsFallback:
        'Fell back to built-in default models ({count}) because the official model list could not be fetched',
    ...
    settings: {
      ...
      urlAllowlist: {
        title: 'Upstream URL Allowlist',
        description: 'Manage allowlist validation for account upstream Base URLs.',
        enabled: 'Enable URL Allowlist',
        enabledHint:
          'When enabled, only allowlisted upstream hosts may be used in account Base URLs.',
        upstreamHosts: 'Allowed Upstream Hosts',
        upstreamHostsHint:
          'Supports comma or newline separators. Full URLs are accepted and normalized to hostnames on save.',
        upstreamHostsPlaceholder: 'api.openai.com\napi.anthropic.com\napi.ojason.top'
      },
      turnstile: {
