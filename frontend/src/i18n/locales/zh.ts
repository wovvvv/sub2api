export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      importModels: '导入模型',
      importingModels: '导入中...',
      importModelsSuccess: '已导入 {count} 个模型',
      importModelsFallback: '官方模型列表获取失败，已回退默认模型列表（{count} 个）',
    ...
    settings: {
      ...
      urlAllowlist: {
        title: '上游 URL 白名单',
        description: '管理账号上游 Base URL 的白名单校验。',
        enabled: '启用 URL 白名单',
        enabledHint: '启用后，仅允许白名单中的上游主机用于账号 Base URL。',
        upstreamHosts: '允许的上游主机',
        upstreamHostsHint: '支持逗号或换行分隔。可粘贴完整 URL，保存时会自动提取主机名。',
